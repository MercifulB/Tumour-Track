...
(function(w) {
    ...
    */
    var canvas_width = Math.ceil(window.innerWidth / 10) * 10 - 100; //Needs to be a multiple of the resolution value below.
    var canvas_height =  Math.ceil(window.innerHeight / 10) * 10 - 100; //This too.
    ...
    var speck_count = 6000; //This determines how many particles will be made.
